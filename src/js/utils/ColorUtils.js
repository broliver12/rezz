...
function getBestTextColorGivenBackground(bgColor) {
  if (!colourNameToHex(bgColor)) {
    print("No hex match for color: " + bgColor);
  }
  var color = hexToRgb(colourNameToHex(bgColor));
  return (((color.r * 0.299) + (color.g * 0.587) + (color.b * 0.114)) > 130) ? "#000000" : "#FFFFFF";
}
