function offset_1_3_5_setCalculator() {
  ...
  outerRingSet[0] = outerRingCounter.getNextVal(1);
  outerRingSet[1] = outerRingCounter.getNextVal(2);
  outerRingSet[2] = outerRingCounter.getNextVal(3);
  outerRingSet[3] = outerRingCounter.getNextVal(4);
  outerRingSet[4] = outerRingCounter.getNextVal(5);
